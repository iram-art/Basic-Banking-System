...
<body style="background-image:url('send-money.png');background-size:1350px;
            background-repeat:no-repeat;height:900px; width: 100%;padding-top:8%;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="l.png" alt=""
                    style="height: 50px; margin-left:20px; margin-top:10px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="check_blc.php">Check Balance</a>
                    </li>
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px;border-color:black; border-radius:30px; box-shadow: 2px 2px 10px grey;">
                <h1 style=" color:white;">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;border-color:black;  ">
...
if($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    $checkblcquery = "SELECT Balance FROM users where Account_No='$sender'";
    $checkblc = mysqli_query($conn, $checkblcquery);
    $ava_blc = mysqli_fetch_assoc($checkblc)['Balance'];

    if($ava_blc >= $amount){
    $sql1 = "UPDATE users SET Balance=Balance -$amount WHERE Account_No='$sender'";
    $sql2 = "UPDATE users SET Balance= Balance+$amount WHERE Account_No='$reciever'";
