        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            ...
            <div class="container"
                ...
                <form action="check_blc.php" method="post">
                    <input type="text" class="formin form-control" name="Account_No" id="" placeholder="Account_No"><br>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Submit"><br><br>
                    <p style="color:black;">Don't remember your account number? check <a href="all_cust.php">here</a>
                    </p>
                </form>
            </div>
        </div>
