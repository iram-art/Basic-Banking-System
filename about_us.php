...
<body style="background-color:black;background-image:url('about.png');">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="l.png" alt=""
                    style="height: 60px; margin-left:20px; margin-top:0px;"></a>
    ...
    <center>
        <div class="container" style="margin-top: 5%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="task.png" alt="" style="width:50%;height:30%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This #task1 website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Iram Syed</h1>
            <p style="color:blue;"><b><font size="+2">Intern at Sparks Foundation </font> </b></p>
    </center>
