...
<div id="container">
    ...
    <div class="container-large"
        style="color:#FFD700; height:800px; width: 100%; padding:8% 2% 2% 2%; background-image:url('back.png');">
        
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> IS Sparks
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:3% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="bank.png" alt="" style="height:500px;width:100%; position:absolute; z-index:-1">
